...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (auth != null) {
			logger.info(
					"Utilizando forma estatica SecurityContextHolder.getContext().getAuthentication(): Usuario autenticado: "
							.concat(auth.getName()));
		}
	...
	private boolean hasRole(String role) {
		 ...
		 * logger.info("Hola ususario ".concat(auth.getName()).concat(" tu rol es: "
